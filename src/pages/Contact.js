                  ...
                  <div>
                    <ul className="ps-0">
                      ...
                      <li className="mb-3 d-flex gap-15 align-items-center">
                        ...
                        <p className="mb-0">Monday to Friday <br /> 10 AM to 8 PM</p>
                      </li>
                    </ul>
                  </div>
                </div>
