            ...
            <div className="main-product-image">
              <div>
                <CustomImageZoom
                  ...
                  height="600"
                  zoomWidth="600"
                  img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdpohHKVxuvIvc8y8LZQnQzdc-OIaH_LU6W-W1eXnA&s"
                />
              </div>
            </div>
              ...
              <div className="py-3">
                ...
                <div className="d-flex gap-15 flex-row mt-2 mb-3">
                  ...
                  <div className="d-flex align-items-center gap-30 mt-2 mb-3">
                    ...
                    <button type="submit" to="/sign-up" className="button signup">Buy it now</button>
                  </div>
                </div>
                ...
                <div className="d-flex gap-10 align-items-center my-3">
                  ...
                  <button type="button" className="copy-link bg-transparent border-0" onClick={() => { copyToClipboard('http://localhost:3000/store/product/id'); }}>Copy Product Link</button>
                </div>
              </div>
            </div>
          </div>
