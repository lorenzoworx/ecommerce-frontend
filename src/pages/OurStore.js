            ...
            <div className="filter-sort-grid mb-4">
              <div className="d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center gap-10">
                  ...
                  <select defaultValue="best-selling" name="" id="" className="form-control form-select">
                ...
                <div className="d-flex align-items-center gap-10">
                  ...
                  <div className="d-flex align-items-center gap-10 grid">
                    <img src={grid4} alt="grid-layout" className="d-block img-fluid" onClick={() => { setGrid(3); }} />
                    <img src={grid3} alt="grid-layout" className="d-block img-fluid" onClick={() => { setGrid(4); }} />
                    <img src={grid2} alt="grid-layout" className="d-block img-fluid" onClick={() => { setGrid(6); }} />
                    <img src={grid1} alt="grid-layout" className="d-block img-fluid" onClick={() => { setGrid(12); }} />
                  </div>
                </div>
              </div>
            </div>
